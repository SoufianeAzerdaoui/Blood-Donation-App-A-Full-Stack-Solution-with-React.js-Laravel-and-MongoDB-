    ...
    <div>
      ...
      <p className='text-gray-400'>/AB Negative blood type </p>
        ...
        <div  className='pl-10 pt-8'>
          ...
          <h2 class="mb-4 pt-10 text-4xl font-semibold leading-none tracking-tight  md:text-5xl lg:text-6xl ">How  <mark class="px-2 text-white bg-blue-600 rounded dark:bg-blue-500">rare</mark> is AB  negative blood ?</h2>
          ...
          <div className='grid sm:grid-cols-2 md:grid-cols-3 gap-8 sm:px-5 items-center '>
            ...
            In total only 3% of donors belong to the AB blood group.            </p>
            <img
