...
import typeABgive from '../../../images/opostive.png';
...
const BloodtypeA = () => {
  ...
  <motion.div
    ...
    <div  className='flex'>
      ...
      <p className='text-gray-400 '>/O positive blood type </p>
      </div>
    </div>
      ...
      <div  className='pl-10 pt-8'>
        ...
        <h2 class="mb-4 pt-10 text-5xl font-bold leading-none tracking-tight  md:text-5xl lg:text-6xl ">How  <mark class="px-2 text-white bg-blue-600 rounded dark:bg-blue-500">rare</mark> is O positive blood ?</h2>
...
<div className='pl-5 w-full  pt-5 w-[35rem] '><img
      ...
      />
        ...
        <ul class="list-disc list-inside pl-10 pt-5">
          <li class="mb-2 font-bold"> O positive people</li>
          <li class="mb-2 font-bold"> A positive people</li>
